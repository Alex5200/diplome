...
from app.config.constants import (
    MAX_POSITION, KINEMA_COLORS, FANUC_BG, FANUC_PANEL, FANUC_GREEN
)
...
class KinematicsVisualizer:
    ...
    def _create_buttons(self):
        ...
        ttk.Button(
            btn_frame,
            text="🎯 Центр (2048)",
            command=self._center_positions
        ).pack(side='left', padx=5)
    ...
    def run(self):
        ...
        print(f"Длины звеньев: L0={self.kinematics.L0}, L1={self.kinematics.L1}, "
