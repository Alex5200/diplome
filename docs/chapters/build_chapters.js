/**
 * ============================================================
 *  СБОРЩИК ДИПЛОМНОЙ РАБОТЫ (ВВЕДЕНИЕ + ГЛАВЫ 1–3 + ЛИТЕРАТУРА)
 * ============================================================
 *
 *  Запуск:
 *    cd docs/chapters
 ...
 *
 *  Результат:
 *    docs/chapters/diploma_full.docx
 *
 *  Структура:
 *    - ВВЕДЕНИЕ
 ...
 *      2.9 Зеркалирование симуляции на реальный робот (Sim-to-Real)
...
console.log("=== Сборка дипломной работы (Введение + Главы 1–3 + Литература) ===\n");
...
// ========== СОХРАНЕНИЕ ==========
const outPath = path.join(__dirname, "diploma_full.docx");
