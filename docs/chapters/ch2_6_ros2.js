...
module.exports = function (h) {
  ...
  c.push(h.codeCaption("Листинг 2.11 — Нода robot_node: публикация состояния суставов"));
  c.push(...h.codeBlock([
  ...
  c.push(h.codeCaption("Листинг 2.12 — Фрагмент launch-файла"));
  c.push(...h.codeBlock([
